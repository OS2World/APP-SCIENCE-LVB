...
void   collabranch(node *,node *,node *,node *,long *,unsigned char *);
...
boolean passdown(node *, node *, node *, node *, node *, node *, node *,
		node *, node *, boolean, long *, unsigned char *);
...
boolean zeroinsubtree(node *, node *, node *, node *, node *, node *,
		node *, node *, boolean , long *, unsigned char *);
boolean collapsible(node *, node *, node *, node *, node *, node *,
		node *, node *, boolean , long *, unsigned char *, pointarray);
