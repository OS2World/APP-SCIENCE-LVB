...
extern boolean interleaved, printdata, outgropt, treeprint,
									dotdiff, transvp;
...
void   freenumsteps(long, pointarray);
void   freebase(long, pointarray);
...
void   savetree(node *, node *, long *, pointarray, node **, long *);
...
void   collabranch(node *, node *, node *, node *, long *);
...
boolean collapsible(node *, node *, node *, node *, node *,
		node *, node *, node *, boolean, long *, pointarray);
...
void   branchlength(node *,node *,node *,double *,long ,pointarray);
...
#if LVB	/* add missing declaration for treeout3() - DB */
...
void   standev(long, long, long, double, double *, long **);
void   standev2(long, long, long, long, long, double, double *,
		double **,steptr);
void   freetip(node *);
